...
def validacionPing():
    ...
    global GasPing = os.system("ping -n 1 " + ArduinoGas)
    global IluminacionPing = os.system("ping -n 1 " + ArduinoIluminacion)
    global PuertasPing = os.system("ping -n 1 " + ArduinoPuertas)
    global AlarmasPing = os.system("ping -n 1 " + ArduinoAlarma)
    print("VALIDANDO")
    #INCIO DE PRUEBAS
    if GasPing == 0:
        print( 'Funciona GAS')
